...
# Relay getRepo budget is about 3000 calls / 5 minutes (~10/s). Stay under that.
DEFAULT_WORKERS = 2
GETREPO_MIN_INTERVAL_SECONDS = 0.2
GETREPO_MAX_ATTEMPTS = 5
GETREPO_BASE_BACKOFF_SECONDS = 3.0
GETREPO_MAX_BACKOFF_SECONDS = 30.0
GETREPO_RATE_LIMIT_COOLDOWN_SECONDS = 45.0
