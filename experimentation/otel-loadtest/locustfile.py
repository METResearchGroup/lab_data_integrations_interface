                            ...
                            "spans": [
                                {
                                    ...
                                    "endTimeUnixNano": str(
                                        now + random.randint(1_000_000, 500_000_000)
                                    ),
                                    "attributes": [
                                        {
                                            "key": "http.method",
                                        ...
                                        },
                                        {
                                            ...
                                            "value": {
                                                "intValue": str(random.choice([200, 201, 400, 500]))
                                            },
                                        },
                                    ],
                                    ...
                                    "attributes": [
                                        {
                                            "key": "http.status_code",
                                            "value": {
                                                "intValue": str(random.choice([200, 400, 500]))
                                            },
                                        },
                                        {
                                            "key": "trace_id",
